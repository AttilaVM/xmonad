...
kmi = km.keymap_items.new('view3d.viewport_rename', 'N', 'PRESS', oskey=True)
kmi = km.keymap_items.new('view3d.cycle_pivot_options', 'R', 'PRESS', oskey=True)
kmi = km.keymap_items.new('wm.save_reload', 'O', 'PRESS', oskey=True)
kmi = km.keymap_items.new('view3d.cycle_pivot_options', 'R', 'PRESS', oskey=True)
kmi = km.keymap_items.new('wm.save_reload', 'O', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('wm.save_mainfile', 'P', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('ed.redo', 'Z', 'PRESS', oskey=True)
kmi = km.keymap_items.new('ed.undo_history', 'Z', 'PRESS', shift=True, oskey=True)
kmi = km.keymap_items.new('render.render', 'F1', 'PRESS')
kmi_props_setattr(kmi.properties, 'use_viewport', True)
kmi = km.keymap_items.new('render.render', 'F2', 'PRESS')
kmi_props_setattr(kmi.properties, 'animation', True)
kmi_props_setattr(kmi.properties, 'use_viewport', True)
kmi = km.keymap_items.new('render.view_cancel', 'ESC', 'PRESS')
kmi = km.keymap_items.new('render.view_show', 'F1', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('render.play_rendered_anim', 'F2', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('view3d.properties', 'TWO', 'PRESS', oskey=True)
kmi = km.keymap_items.new('view3d.toolshelf', 'ONE', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('gpencil.select_linked', 'N', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('anim.keyframe_delete_v3d', 'Y', 'PRESS', alt=True)
...
kmi_props_setattr(kmi.properties, 'action', 'TOGGLE')
kmi = km.keymap_items.new('object.select_all', 'T', 'PRESS')
kmi_props_setattr(kmi.properties, 'action', 'INVERT')
...
kmi = km.keymap_items.new('object.select_hierarchy', 'FOUR', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'direction', 'PARENT')
kmi_props_setattr(kmi.properties, 'extend', False)
kmi = km.keymap_items.new('object.select_hierarchy', 'LEFT_BRACKET', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'direction', 'PARENT')
kmi_props_setattr(kmi.properties, 'extend', True)
kmi = km.keymap_items.new('object.select_hierarchy', 'THREE', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'direction', 'CHILD')
kmi_props_setattr(kmi.properties, 'extend', False)
...
kmi = km.keymap_items.new('anim.keyframe_insert_menu', 'Y', 'PRESS')
kmi = km.keymap_items.new('anim.keyframe_delete_v3d', 'Y', 'PRESS', alt=True)
kmi = km.keymap_items.new('anim.keying_set_active_set', 'Y', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('curve.split', 'K', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties, 'action', 'INVERT')
kmi = km.keymap_items.new('mesh.select_more', 'FOUR', 'PRESS', oskey=True)
kmi = km.keymap_items.new('mesh.select_less', 'THREE', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('mesh.split', 'K', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('armature.split', 'K', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties, 'toggle', True)
kmi = km.keymap_items.new('object.origin_set', 'Q', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('view3d.view_all', 'D', 'PRESS', shift=True, ctrl=True)
...
kmi = km.keymap_items.new('view3d.viewnumpad', 'C', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'CAMERA')
kmi = km.keymap_items.new('view3d.viewnumpad', 'W', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('view3d.viewnumpad', 'D', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('view3d.view_persportho', 'A', 'PRESS', shift=True, oskey=True)
kmi = km.keymap_items.new('view3d.view_orbit', 'NUMPAD_6', 'PRESS')
kmi_props_setattr(kmi.properties, 'type', 'ORBITRIGHT')
kmi = km.keymap_items.new('view3d.viewnumpad', 'W', 'PRESS', shift=True, oskey=True)
...
kmi = km.keymap_items.new('view3d.viewnumpad', 'S', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'BACK')
kmi = km.keymap_items.new('view3d.viewnumpad', 'A', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'LEFT')
kmi = km.keymap_items.new('view3d.viewnumpad', 'S', 'PRESS', shift=True, oskey=True)
...
kmi_props_setattr(kmi.properties, 'type', 'BOTTOM')
kmi_props_setattr(kmi.properties, 'align_active', True)
kmi = km.keymap_items.new('view3d.localview', 'D', 'PRESS', shift=True, alt=True)
...
kmi_props_setattr(kmi.properties, 'extend', True)
kmi = km.keymap_items.new('uv.select_split', 'K', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties, 'extend', False)
kmi = km.keymap_items.new('uv.select_linked', 'N', 'PRESS', shift=True, alt=True)
kmi_props_setattr(kmi.properties, 'extend', True)
...
kmi = km.keymap_items.new('graph.properties', 'TWO', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('image.properties', 'TWO', 'PRESS', oskey=True)
kmi = km.keymap_items.new('image.toolshelf', 'ONE', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('node.properties', 'TWO', 'PRESS', oskey=True)
kmi = km.keymap_items.new('node.toolbar', 'ONE', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('action.properties', 'TWO', 'PRESS', oskey=True)

# Map NLA Generic
km = kc.keymaps.new('NLA Generic', space_type='NLA_EDITOR', region_type='WINDOW', modal=False)

kmi = km.keymap_items.new('nla.properties', 'TWO', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('nla.split', 'K', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('text.properties', 'TWO', 'PRESS', oskey=True)

# Map SequencerCommon
km = kc.keymaps.new('SequencerCommon', space_type='SEQUENCE_EDITOR', region_type='WINDOW', modal=False)

kmi = km.keymap_items.new('sequencer.properties', 'TWO', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('sequencer.images_separate', 'K', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('logic.properties', 'TWO', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('clip.tools', 'ONE', 'PRESS', oskey=True)
kmi = km.keymap_items.new('clip.properties', 'TWO', 'PRESS', oskey=True)
